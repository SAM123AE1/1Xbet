...
public class Serverlaunch_generalstoreTest {
	@Parameters({"id","dName"})
	@Test
	public void Task_Of_HandM1(String dName,String id) throws MalformedURLException, URISyntaxException, InterruptedException {
		//to start the server
File f=new File("C:\\Users\\kmyas\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js");
 ...
 service.start();
		...
		desire.setCapability("deviceName", dName);
